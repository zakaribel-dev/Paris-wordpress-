...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.rarathemes.com/docs/rara-business/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'rara-business' ); ?>" target="_blank">
